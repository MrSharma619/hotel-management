...
int stayTime;
    ...
    private void initComponents() {
        ...
        year1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2014", "2015", "2016" }));
    ...
    private void SearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBtnActionPerformed
        ...
        if(day1 == day2){
            ...
            stayTime = (int)((c2.getTimeInMillis() - c.getTimeInMillis())/(1000*60*60*24) + 1);   
        }
        ...
        try {
            ...
            while(rs.next())
            {
               ...
               for(i=day1; i<=max; i++)
               {
                   ...
                   // b- booked && no null values allowed
                   // try and add 'a' - available into tables
                   if (avail.equals("b") || avail.equals("NULL"))
                       break;
               }
